...
const contractABI = require("../artifacts/contracts/Quantumleap.sol/Quantumleap.json").abi;

program
    .name("quantumleap-cli")
    .description("CLI tool for Quantumleap smart contract")
    .version("1.0.0");
